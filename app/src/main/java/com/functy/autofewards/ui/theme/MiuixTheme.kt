...
/** Miuix 单主题引擎（照 KSU MiuixKernelSUTheme，去掉 Monet CSS 通知）。 */
@Composable
fun AutoFewardsTheme(
    ...
    val miuixColorSpec = if (appSettings.colorSpec.effectiveFor(appSettings.paletteStyle) == com.materialkolor.dynamiccolor.ColorSpec.SpecVersion.SPEC_2025) {
    ...
    val resolvedKeyColor: Color? = when {
        ...
        appSettings.colorMode.isMonet ->
            if (darkTheme) androidx.compose.material3.dynamicDarkColorScheme(context).primary
